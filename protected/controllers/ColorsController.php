...
class ColorsController extends Controller
{
	...
	public function JSON_to_database($json = NULL) {
		if($json == NULL) $json = itemsGameToJSON()['items_game']['colors'];
		foreach($json as $color=>$colorInfo) {
			$model = new Colors();
			$model->color = $color;
			$model->color_name = $colorInfo['color_name'];
			$model->hex_color = $colorInfo['hex_color'];
			if(!$model->save()) {
